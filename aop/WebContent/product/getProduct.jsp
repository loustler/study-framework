	...
	<form name="detailForm" method="post">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 13px;">
			...
			<tr>
				...
				<td bgcolor="D6D6D6" width="1"></td>
				<td class="ct_write01">
					<img src="/images/uploadFiles/${product.fileName}"alt="upload Image"width="200" height="150"></td>
			</tr>
			<tr>
				<td height="1" colspan="3" bgcolor="D6D6D6"></td>
			</tr>
						...
						<tr>
							<u:if test="${user.role =='admin' && (empty product.proTranCode )}">
								...
								<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top: 3px;">
									<a href="/updateProductView.do?prodNo=${product.getProdNo()}">수정하기</a>
								</td>
							...
							<u:if test="${!empty menu && menu=='search' && (empty product.proTranCode) && sessionScope.user.role=='user'}">
								...
								<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top: 3px;">
									<a href="/addPurchaseView.do?prodNo=${product.getProdNo()}">구매하기</a>
								</td>
								<td width="14" height="23">
									<img src="/images/ct_btnbg03.gif" width="14" height="23">
								</td>
							...
							<u:if test="${!empty menu && menu =='manage'}">
								...
								<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top: 3px;">
									<a href="/listSale.do?menu=${menu}">확인</a>
								</td>
								<td width="14" height="23">
									<img src="/images/ct_btnbg03.gif" width="14" height="23">
								</td>
