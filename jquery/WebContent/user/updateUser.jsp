		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 13px;">
			...
			<tr>
				...
				<td class="ct_write01">
					...
					<input type="text" name="phone2" value="${user.phone2}" class="ct_input_g" style="width: 100px; height: 19px" maxLength="9" />
					-
					<input type="text" name="phone3" value="${user.phone3}" class="ct_input_g" style="width: 100px; height: 19px" maxLength="9" />
