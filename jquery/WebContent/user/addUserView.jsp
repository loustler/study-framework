...
<!--
	function fncAddUser() {
		...
		var pw_check = $('input[name="password2"]').val();
		...
		if (pw_check == null || pw.length < 1) {
			alert('password 확인은 반드시 입력해주세요');
			return;
		}
	...
	<form name="detailForm">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 13px;">
			...
			<tr>
				...
				<td bgcolor="D6D6D6" width="1"></td>
				<td class="ct_write01">
					<input type="password" name="password" class="ct_input_g" style="width: 100px; height: 19px" maxLength="10" minLength="6" />
				</td>
			</tr>
