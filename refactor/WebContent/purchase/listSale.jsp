		...
		<form name="detailForm" action="/listSale.do" method="post">
						...
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top: 3px;">
									<a href="javascript:fncGetListSale('1');">검색</a>
								</td>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 10px;">
				...
				<tr class="ct_list_pop">
					...
					<td align="left">
						<a href="/getProduct.do?prodNo=<%=product.getProdNo()%>"> <%=product.getProdName()%>
						</a>
					</td>
					...
					<td></td>
					<%
						if (product.getProTranCode().equals("배송대기")) {
					%>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 10px;">
					<tr>
						<td align="center">
							...
							%>
							<a href="javascript:fncGetListSale('<%=resultPage.getCurrentPage() - 1%>');">◀ 이전</a>
							<%
								}
							%>
							<%
							...
							%>
							<a href="javascript:fncGetListSale('<%=i%>')"><%=i%></a>
							<%
								}
							%>
							<%
							...
							%>
							<a href="javascript:fncGetListSale('<%=resultPage.getEndUnitPage() + 1%>');">이후 ▶</a>
							<%
								}
							%>
						</td>
