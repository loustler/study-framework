	...
	<tr>
		...
		<td class="ct_write01">
			<select 	name="paymentOption" 	class="ct_input_g" style="width: 100px; height: 19px" 
							maxLength="20">
				<option value="000" <%= purchase.getPaymentOption().equals("000") ? "selected" : "" %>>현금구매</option>
				<option value="001" <%= purchase.getPaymentOption().equals("001") ? "selected" : "" %>>신용구매</option>
			</select>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="ct_write01">
			<input 	type="text" name="receiverRequest" 	class="ct_input_g" style="width: 100px; height: 19px" 
							maxLength="20" value="<%=purchase.getDlvyReq() %>" />
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
