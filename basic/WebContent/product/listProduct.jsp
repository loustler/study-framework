...
<%
	...
	int total = 0;
	if(request.getAttribute("count")!=null && request.getAttribute("purList")!=null&&request.getAttribute("proList")!=null&&request.getAttribute("searchVO")!=null) {
		...
		System.out.println("listProduct request Att Error");
	}
