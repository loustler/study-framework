...
UserVO userVO = null;
if(request.getAttribute("product")!= null && request.getAttribute("userVO")!=null) {
	productVO = (ProductVO) request.getAttribute("product");
	userVO = (UserVO)request.getAttribute("userVO");
}else {
	System.out.println("addPurchaseView vo not exist");
}
...
<table width="100%" height="37" border="0" cellpadding="0"	cellspacing="0">
	<tr>
		...
		<td width="12" height="37">
			<img src="<%=productVO.getFileName() %>" width="12" height="37"/>
		</td>
	</tr>
</table>
