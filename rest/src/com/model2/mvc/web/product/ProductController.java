...
public class ProductController {
	...
	public void addProductJson(@RequestBody Product product, Model model,
		...
		System.out.println("Origin FileName : " + fileName);
		String path = "/Users/DY/Documents/workspace/8.Model2MVCShop(Presentation+BusinessLogic)/WebContent/images/uploadFiles/";
	...
	public void getProductJson(@RequestParam("prodNo") int prodNo, Model model) throws Exception{
		Product product = productService.getProduct(prodNo);
