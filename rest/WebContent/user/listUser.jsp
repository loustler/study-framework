...
<body bgcolor="#ffffff" text="#000000">
	...
	<div style="width: 98%; margin-left: 10px;">
		...
		<form name="detailForm">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 10px;">
				<tr>
					<td align="right">
						...
						</select> <input type="text" name="searchKeyword" value="${search.searchKeyword }" class="ct_input_g" style="width: 200px; height: 20px">
					</td>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 10px;">
				<tr>
					<td colspan="6">전체 ${resultPage.getTotalCount()} 건수, 현재 ${resultPage.getCurrentPage()} 페이지</td>
				...
				<l:forEach var="user" items="${requestScope.list}" begin="0" step="1">
					...
					<tr class="ct_list_pop">
						...
						<td></td>
						<td align="left">
							<a href="/user/getUser?userId=${user.getUserId()}">${user.getUserId()}</a>
						</td>
						<td></td>
